...
// QuickType USB-UART native host bridge build: 0.2.6 (2026-07-25)
#include <Arduino.h>
...
static constexpr char BRIDGE_FIRMWARE_VERSION[] = "0.2.6";
...
void setup() {
  ...
  sendBridgeVersion();
  writeLog("⚡ UART Bridge Board Reset / Booted (v0.2.6)");
